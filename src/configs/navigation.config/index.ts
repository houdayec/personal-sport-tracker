...
const navigationConfig: NavigationTree[] = [
    ...
    },
    {
        ...
        title: 'Progression',
        translateKey: 'nav.fitness.progress.title',
        icon: 'progress',
        type: NAV_ITEM_TYPE_COLLAPSE,
        authority: [],
        subMenu: [
            {
                key: 'fitness.progress.body',
                path: FITNESS_ROUTES.progress,
                title: 'Suivi du corps',
                translateKey: 'nav.fitness.progress.body',
                icon: '',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],
            },
            {
                ...
                title: 'Comparaison photos',
                translateKey: 'nav.fitness.progress.photos',
                icon: '',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],
            },
            {
                ...
                title: 'Progression d’exercice',
                translateKey: 'nav.fitness.progress.exercise',
                icon: '',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],

...
export const legacyProtectedRoutes: Routes = [
    {
        key: 'stats.revenue',
        path: '/stats/revenue',
    ...
    },
    {
        key: 'stats.sales',
        path: '/stats/sales',
        component: lazy(() => import('@/views/stats/Sales')),
        authority: ['USER'],
    },
    {
        key: 'website.stats',
    ...
    {
        key: 'products.thumbnailMetadata',
        path: '/products/:id/generate-thumbnail-metadata',
        component: lazy(
            () =>
                import(
                    '@/views/products/ProductEdit/components/ThumbnailMetadataGenerator'
                ),
        ),
        authority: ['USER'],
    },
    {
        key: 'products.etsyMetadata',
        path: '/products/:id/generate-etsy-metadata',
        component: lazy(
            () => import('@/views/products/ProductEdit/components/EtsyListingGeneratorHome'),
        ),
        authority: ['USER'],
    },
    {
        key: 'products.websiteListing',
        path: '/products/:id/generate-website-listing',
        component: lazy(
            () =>
                import('@/views/products/ProductEdit/components/WebsiteListingGeneratorHome'),
        ),
        authority: ['USER'],
    },
    {
    ...
    },
    {
        ...
        component: lazy(
            () =>
                import('@/views/products/ProductEdit/components/ThumbnailMetadataGenerator'),
        ),
        authority: ['USER'],
    },
    {

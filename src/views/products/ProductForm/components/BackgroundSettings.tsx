    ...
    return (
        <>
            <Card>
                ...
                <h5 className="font-semibold mb-2 mt-4">Pattern</h5>

                <FormItem label="Pattern Source">
                    {/* Top: pattern options row */}
                        ...
                        {PATTERNS.map(p => (
                            <div key={p.name} className="relative flex-shrink-0">
                                <button
                                    ...
                                    className={`p-1 border rounded transition ${main_patternType === p.name ? 'border-blue-500 ring-1 ring-blue-400' : 'border-gray-300 hover:border-gray-400'}`}
                                >
                                    {p.src ? (
                    ...
                    {/* Bottom: pattern settings (compact grid) */}
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
                        <FormItem label="Color">
                            <Field
                                name="thumbnailsMetadata.main_patternColor"
                                type="color"
                                component={Input}
                            />
                        </FormItem>
                        ...
                        <div className="col-span-2 lg:col-span-1 flex items-center space-x-2 mt-2">

...
import { getWebsiteSalesDashboardData, useAppSelector } from '../store'
import { useAppDispatch } from '@/store'
import SalesReportBars from './SalesReportBars'
import { apiGetWebsiteSalesDashboardData, apiGetWebsiteSalesDashboardData2 } from '@/services/SalesService'
...
const EtsySalesDashboardBody = () => {
    ...
    const fetchData = () => {
        dispatch(getWebsiteSalesDashboardData({ startDate, endDate }))
    }
